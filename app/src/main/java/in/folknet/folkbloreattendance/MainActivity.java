...
DatabaseReference mName,mId,mFg,mWs,mCount,mdv,myear,mNewCount, mdfl;
...
String fgNum,timeNu, selected_area;
    String temp;
    Bundle bundle;
    String message,year_fb="4",name,fid,fg,ws,time, mjp, fl, mob;
    int counter;
    int a = -1,bb;
...
//        inputPane.setVisibility(View.VISIBLE);
        ...
        mdfl = FirebaseDatabase.getInstance().getReference().child("New Database").child("FOLK_LEVEL").child(fgNum).child(fl);
...
//                bb = dataSnapshot.getValue(int.class);
//            }
//            @Override
//            public void onCancelled(DatabaseError databaseError) {}
//        };
//        myear.addValueEventListener(postListener1);
//
//        ValueEventListener postListener = new ValueEventListener() {
//            @Override
//            public void onDataChange(DataSnapshot dataSnapshot) {
//                // Get Post object and use the values to update the UI
//                a = dataSnapshot.getValue(int.class);
//                pd.hide();
//            }
//            @Override
//            public void onCancelled(DatabaseError databaseError) {}
//        };
//        mdv.addValueEventListener(postListener);

//        ValueEventListener postListener3 = new ValueEventListener() {
//            @Override
//            public void onDataChange(DataSnapshot dataSnapshot) {
//                // Get Post object and use the values to update the UI
//                newCount = dataSnapshot.getValue(int.class);
//                pd.hide();
//            }
//            @Override
//            public void onCancelled(DatabaseError databaseError) {}
//        };
//        mNewCount.addValueEventListener(postListener3);
...
//                    newCount++;
                    ...
                    mdfl.child(fid).setValue(name + " : (" + fid + ")" + " " + time);
                    ...
                    mName.child("ZFL").setValue(fl);
                    mName.child("Zmob").setValue(mob);
